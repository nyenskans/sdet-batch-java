...
public class ExcelReader {
    // we create a method from the code that we wrote in class ** ExcelFileReading2 ** because we will use it repeatedly
    public static List<Map<String,String>> readExcelFile(String path) throws IOException {
        ...
        LinkedHashMap<String,String> rowData; // linkedHash so it would keep insertion order
